...
related_docs: Docs/Agent/ADR/ADR_INDEX.md, Docs/Agent/KNOWLEDGE/KNOWLEDGE_ENGINEERING_ROADMAP.md
---
...
| RelatedDocs | `ADR/ADR_02_DANMAKU.md`, `SYSTEMS/OBB_TDD/OBB_TDD_INDEX.md`, `CONTEXT_PACKS/EntitySystem.md`, `CONTEXT_PACKS/Danmaku_Rendering.md`, `MODULE_CARDS/EntitySystem.md`, `MODULE_CARDS/DanmakuSystem.md` |
...
| RelatedDocs | `SYSTEMS/ATLAS_TDD/ATLAS_TDD_INDEX.md`, `ARCHITECTURE.md`, `MODULE_CARDS/Rendering_RuntimeAtlas.md` |
...
| RelatedDocs | `ADR/ADR_05_RECENT.md`, `MODULE_CARDS/Rendering_RuntimeAtlas.md`, `DEBUG_PLAYBOOK.md` |
...
| RelatedDocs | `ADR/ADR_05_RECENT.md`, `DEBUG_PLAYBOOK.md` |
...
| RelatedDocs | `SYSTEMS/EC_TDD/EC_TDD_INDEX.md`, `MODULE_CARDS/EntitySystem.md`, `CONTEXT_PACKS/EntitySystem.md` |
...
| RelatedDocs | `SYSTEMS/APPFLOW_TDD/APPFLOW_TDD_INDEX.md`, `SHOOTER_GAME/SG_V2_DEVICE_ACCEPTANCE.md` 第六部分, `MODULE_CARDS/AppFlow.md` |
...
| RelatedDocs | `ADR/ADR_06_LIFECYCLE.md`, `SHOOTER_GAME/V2_TDD/SG_V2_TDD_07_LIFECYCLE.md`, `MODULE_CARDS/ShooterGame.md`, `MODULE_CARDS/EntitySystem.md` |
...
| RelatedDocs | `SYSTEMS/FLOATING_TEXT/FLOATING_TEXT_TDD.md`, `ADR/ADR_06_LIFECYCLE.md`, `MODULE_CARDS/Rendering_RuntimeAtlas.md` |
...
2. 在 `ADR/ADR_INDEX.md` 中维护可执行摘要入口。
3. P4 建立 `KNOWLEDGE/CODE_KNOWLEDGE_MAP.md` 时引用 `AppliesTo` 和 `Verification` 字段。
