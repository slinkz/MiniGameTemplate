...
| APPFLOW | `APPFLOW_TDD_INDEX.md`, `APPFLOW_TDD_01~05_*.md`；验收统一见 `SG_V2_DEVICE_ACCEPTANCE.md` 第六部分 | 导航系统 | P2 生成 `MODULE_CARDS/AppFlow.md` |
...
| `FAQ.md` | 常见问题 | 辅助排错 |
| `微信小游戏导出到手机完整指南.md` | 旧版真机导出流程 | 已归档为历史参考；当前构建入口以 `BUILD_MINIGAME.md` 与 `WECHAT_INTEGRATION.md` 为准 |
...
| 原路径 | 归档路径 | 当前事实源 |
|--------|----------|------------|
| `Docs/Guide/微信小游戏导出到手机完整指南.md` | `Docs/Agent/Archive/Guide/微信小游戏导出到手机完整指南.md` | `Docs/Guide/BUILD_MINIGAME.md`, `WECHAT_INTEGRATION.md`, `CONTEXT_PACKS/WeChat_Build_Cloud.md` |
...
| `Docs/Agent/APPFLOW_ACCEPTANCE_PLAN.md` | `Docs/Agent/Archive/AppFlow/APPFLOW_ACCEPTANCE_PLAN.md` | `SG_V2_DEVICE_ACCEPTANCE.md` 第六部分, `APPFLOW_TDD_INDEX.md` |
| `Docs/Agent/TDD05_S54_S56_ACCEPTANCE_GUIDE.md` | `Docs/Agent/Archive/ShooterGame/Acceptance/TDD05_S54_S56_ACCEPTANCE_GUIDE.md` | `SG_V2_DEVICE_ACCEPTANCE.md`, `SG_V2_TDD_05_TOOLS_UI_POLISH.md` |
...
| `Docs/Guide/DANMAKU_RENDERING.md` | `Docs/Agent/Archive/Guide/Danmaku/DANMAKU_RENDERING.md` | `ATLAS_TDD_INDEX.md`, `FLOATING_TEXT_TDD.md`, `MODULE_CARDS/Rendering_RuntimeAtlas.md` |
| `Docs/Guide/DANMAKU_DATA.md` | `Docs/Agent/Archive/Guide/Danmaku/DANMAKU_DATA.md` | `MODULE_CARDS/DanmakuSystem.md`, `SO_WORKFLOWS_03_DANMAKU.md` |
