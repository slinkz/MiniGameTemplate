...
> **来源**：`SHOOTER_GAME/SG_GAME_DESIGN.md` v3.2 §11 + `SHOOTER_GAME/SG_UI_DESIGN.md` v2.0 §十一  
...
| # | 文件 | 内容摘要 | 预估行数 |
|---|------|---------|----------|
| 1 | [SHOOTER_GAME/TOOLS_TDD/SG_TOOLS_TDD_01_WAVE_EDITOR.md](SHOOTER_GAME/TOOLS_TDD/SG_TOOLS_TDD_01_WAVE_EDITOR.md) | EntitySpawnWaveSO CustomEditor（一键复制波次 + 统计面板） | ~200 |
| 2 | [SHOOTER_GAME/TOOLS_TDD/SG_TOOLS_TDD_02_DEBUG_TOOLS.md](SHOOTER_GAME/TOOLS_TDD/SG_TOOLS_TDD_02_DEBUG_TOOLS.md) | Debug MenuItem + 战斗状态监视面板 + Gizmo | ~250 |
