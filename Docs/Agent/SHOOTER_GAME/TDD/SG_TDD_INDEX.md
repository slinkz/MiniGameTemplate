...
> **来源**：`SHOOTER_GAME/SG_GAME_DESIGN.md` v3.2 + `SHOOTER_GAME/SG_UI_DESIGN.md` v2.0  
...
| # | 文件 | 内容摘要 | 预估行数 |
|---|------|---------|----------|
| 1 | [SHOOTER_GAME/TDD/SG_TDD_01_ARCHITECTURE.md](SHOOTER_GAME/TDD/SG_TDD_01_ARCHITECTURE.md) | 总体架构 · 目录结构 · 依赖关系 · 生命周期 · 时序图 | ~250 |
| 2 | [SHOOTER_GAME/TDD/SG_TDD_02_BATTLE_SYSTEM.md](SHOOTER_GAME/TDD/SG_TDD_02_BATTLE_SYSTEM.md) | 战斗状态机 · 底线检测 · 屏幕震动 · 通关/失败判定 · 重试流程 | ~350 |
| 3 | [SHOOTER_GAME/TDD/SG_TDD_03_LEVEL_PROGRESS.md](SHOOTER_GAME/TDD/SG_TDD_03_LEVEL_PROGRESS.md) | 关卡配置SO · 存储系统集成 · 关卡解锁 · 数据流 | ~200 |
| 4 | [SHOOTER_GAME/TDD/SG_TDD_04_UI_CONTROLLERS.md](SHOOTER_GAME/TDD/SG_TDD_04_UI_CONTROLLERS.md) | 6个UI Controller · 数据绑定 · 飘字池 · 血条预损 · 转场编排 | ~350 |
| 5 | [SHOOTER_GAME/TDD/SG_TDD_05_INPUT_JOYSTICK.md](SHOOTER_GAME/TDD/SG_TDD_05_INPUT_JOYSTICK.md) | 虚拟摇杆 · Vector2Variable · 输入→移动管线 · JoystickConfigSO | ~200 |
| 6 | [SHOOTER_GAME/TDD/SG_TDD_06_CLOUD_SAVE.md](SHOOTER_GAME/TDD/SG_TDD_06_CLOUD_SAVE.md) | **V2 微信登录 · 云存储 · 跨设备同步 · 离线优先 · 数据迁移** | ~400 |
...
| v1.5 | 2026-05-07 | 新增 SHOOTER_GAME/TDD/SG_TDD_06_CLOUD_SAVE.md — V2 微信登录+云存储完整 TDD（初稿 v0.1） |
