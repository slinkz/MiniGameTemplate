...
related_docs: Docs/Agent/KNOWLEDGE_ENGINEERING_ROADMAP.md, Docs/Agent/SG_GAME_DESIGN.md, Docs/Agent/SG_GDD_INDEX.md, Docs/Agent/SG_UI_DESIGN.md, Docs/Agent/CONTEXT_PACKS/FairyGUI_UI.md, Docs/Agent/MODULE_CARDS/UISystem_FairyGUI.md, skills/fairygui-tools/SKILL.md, skills/vfx-creator/SKILL.md
---
...
```text
Docs/Agent/
├── DESIGNER_BOOTSTRAP.md
├── UI_AGENT_BOOTSTRAP.md
├── ART_ASSET_AGENT_BOOTSTRAP.md
├── ROLE_AGENT_KNOWLEDGE_EXTENSION_PLAN.md
├── DESIGN/
│   ├── README.md
│   ├── DESIGN_PILLARS.md
│   ├── PLAYER_JOURNEY.md
...
| 文档 | 解决的问题 | 与现有文档关系 |
|------|------------|----------------|
| `DESIGNER_BOOTSTRAP.md` | 策划 Agent 上岗入口：当前游戏、可改范围、交付物、验证方式 | 类似 `AGENT_BOOTSTRAP`，但只面向设计工作 |
...
| 文档 | 解决的问题 | 与现有文档关系 |
|------|------------|----------------|
| `UI_AGENT_BOOTSTRAP.md` | UI Agent 上岗入口：先读 UI 设计系统、屏幕卡、FairyGUI 约束 | 新增角色入口 |
...
| 文档 | 解决的问题 | 与现有文档关系 |
|------|------------|----------------|
| `ART_ASSET_AGENT_BOOTSTRAP.md` | 资产 Agent 上岗入口：任务分型、目录、命名、验收 | 新增角色入口 |
...
| `KNOWLEDGE_MAINTENANCE.md` | 触发条件增加设计卡片、UI 设计系统、资产清单变更 |
| `KNOWLEDGE_EVALS.md` | 新增非代码评估任务 |
...
```text
Docs/Agent/DESIGNER_BOOTSTRAP.md
Docs/Agent/DESIGN/*.md
Docs/Agent/SG_GAME_DESIGN.md
Docs/Agent/SG_GDD_INDEX.md
Docs/Agent/SO_WORKFLOWS_INDEX.md
```
...
```text
Docs/Agent/UI_AGENT_BOOTSTRAP.md
Docs/Agent/UI_DESIGN/*.md
Docs/Agent/SG_UI_DESIGN.md
...
```text
Docs/Agent/ART_ASSET_AGENT_BOOTSTRAP.md
...
1. `DESIGNER_BOOTSTRAP.md`
2. `UI_AGENT_BOOTSTRAP.md`
3. `ART_ASSET_AGENT_BOOTSTRAP.md`
