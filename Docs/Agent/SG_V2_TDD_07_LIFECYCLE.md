...
> **ADR 来源**：ADR-035（`Docs/Agent/ADR_06_LIFECYCLE.md`）  
> **预估工时**：~6h  
...
| 文档 | 关系 |
|------|------|
| `ADR_06_LIFECYCLE.md` | 本 TDD 的设计来源（ADR-035） |
| `EC_TDD_04_SYSTEMS.md` | EntitySystemBootstrap 架构 |
| `SG_V2_TDD_01_ENEMY_SHOOTING.md` | DanmakuSystem 碰撞 → 飘字触发链路 |
| `CONV_03_PLATFORM.md` | WebGL/微信限制（DontDestroyOnLoad 约束） |
