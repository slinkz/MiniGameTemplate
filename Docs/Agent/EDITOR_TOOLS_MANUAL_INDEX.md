...
| # | 文件 | 覆盖范围 | 行数 |
|---|------|---------|------|
| 1 | [EDITOR_TOOLS_MANUAL_01_BUILD.md](EDITOR_TOOLS_MANUAL_01_BUILD.md) | 构建/导出/Dev Server（7 个菜单项） | ~160 |
| 2 | [EDITOR_TOOLS_MANUAL_02_VALIDATE.md](EDITOR_TOOLS_MANUAL_02_VALIDATE.md) | 校验/审计/引用查找（4 个菜单项） | ~130 |
| 3 | [EDITOR_TOOLS_MANUAL_03_ENTITY.md](EDITOR_TOOLS_MANUAL_03_ENTITY.md) | Entity 系统工具（6 个菜单项） | ~140 |
| 4 | [EDITOR_TOOLS_MANUAL_04_INSPECTORS.md](EDITOR_TOOLS_MANUAL_04_INSPECTORS.md) | 自定义 Inspector + 自动处理器 | ~130 |
