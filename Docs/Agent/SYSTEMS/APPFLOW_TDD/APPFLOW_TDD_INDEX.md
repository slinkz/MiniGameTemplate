...
| # | 文件 | 内容 |
|---|------|------|
| 01 | [SYSTEMS/APPFLOW_TDD/APPFLOW_TDD_01_CORE_DESIGN.md](SYSTEMS/APPFLOW_TDD/APPFLOW_TDD_01_CORE_DESIGN.md) | §1 问题定义 + §2 架构设计 + §3 详细设计（FlowNodeSO / AppFlowNavigator / IFlowData / IFlowHandler / IPanelSuspendable） |
| 02 | [SYSTEMS/APPFLOW_TDD/APPFLOW_TDD_02_EDITOR_TOOLS.md](SYSTEMS/APPFLOW_TDD/APPFLOW_TDD_02_EDITOR_TOOLS.md) | §3.5 编辑器工具规格（Inspector / EditorWindow / BuildValidator / HierarchyIcon） |
| 03 | [SYSTEMS/APPFLOW_TDD/APPFLOW_TDD_03_INTEGRATION.md](SYSTEMS/APPFLOW_TDD/APPFLOW_TDD_03_INTEGRATION.md) | §4 系统集成（与现有系统关系 / SO 资产清单 / 导航流程时序 / 场景策略） |
| 04 | [SYSTEMS/APPFLOW_TDD/APPFLOW_TDD_04_TRADEOFFS.md](SYSTEMS/APPFLOW_TDD/APPFLOW_TDD_04_TRADEOFFS.md) | §5 权衡分析 + §6 风险与缓解 |
| 05 | [SYSTEMS/APPFLOW_TDD/APPFLOW_TDD_05_IMPL_PLAN.md](SYSTEMS/APPFLOW_TDD/APPFLOW_TDD_05_IMPL_PLAN.md) | §7 实施计划 + 验收标准 + §8 后续演进 |
