...
| 7 | 战斗状态监视 EditorWindow | P1 | 1h | 核心 SG-P0.3 + SO 资产 | 02 |
| 8 | ~~FairyGUI 包校验 MenuItem~~ | P2 | ~~1h~~ | FairyGUI 包制作后 | 02 |
...
├── SG_FairyGUIValidator.cs      ← FairyGUI 包校验 MenuItem
└── SG_GizmoDrawer.cs            ← BaseLineY + 摇杆 Gizmo
```
