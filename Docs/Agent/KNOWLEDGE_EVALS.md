...
related_docs: Docs/Agent/AGENT_BOOTSTRAP.md, Docs/Agent/CODE_KNOWLEDGE_MAP.md, Docs/Agent/ARCHITECTURE_REVIEW_PROTOCOL.md, Docs/Agent/KNOWLEDGE_MAINTENANCE.md
---
...
| 项 | 期望 |
|----|------|
| 先读 | `CONTEXT_PACKS/SO_Config_Workflow.md`, `CONTEXT_PACKS/EntitySystem.md`, `MODULE_CARDS/EntitySystem.md`, `CODE_KNOWLEDGE_MAP.md` |
...
| 项 | 期望 |
|----|------|
| 先读 | `CONTEXT_PACKS/EntitySystem.md`, `MODULE_CARDS/EntitySystem.md`, `OBB_TDD_INDEX.md`, `CODE_KNOWLEDGE_MAP.md` |
...
| 项 | 期望 |
|----|------|
| 先读 | `CONTEXT_PACKS/WeChat_Build_Cloud.md`, `WECHAT_INTEGRATION.md`, `SG_TDD_06_CLOUD_SAVE.md` |
...
| 项 | 期望 |
|----|------|
| 先读 | `CONTEXT_PACKS/Danmaku_Rendering.md`, `MODULE_CARDS/Rendering_RuntimeAtlas.md`, `DEBUG_PLAYBOOK.md`, `ADR_SCHEMA.md` |
...
| 项 | 期望 |
|----|------|
| 先读 | `ARCHITECTURE_REVIEW_PROTOCOL.md`, `templates/ARCH_REVIEW_TEMPLATE.md`, `ADR_SCHEMA.md`, 相关 Module Card/Context Pack |
| 代码/资产 | 由重构主题决定；必须用 `CODE_KNOWLEDGE_MAP.md` 反查 |
...
| 设计一致性低 | `ADR_SCHEMA.md`, `ARCHITECTURE_REVIEW_PROTOCOL.md` |
| 影响面漏项 | `CODE_KNOWLEDGE_MAP.md`, Module Card |
