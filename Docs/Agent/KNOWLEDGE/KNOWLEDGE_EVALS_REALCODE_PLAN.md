...
related_docs: Docs/Agent/KNOWLEDGE/KNOWLEDGE_EVALS.md, Docs/Agent/KNOWLEDGE/KNOWLEDGE_EVALS_RUN_2026-07-14.md
...
| 维度 | 分数 | 期望行为 |
|------|------|----------|
| 路由 | 2 | Agent 先读 `CONTEXT_PACKS/EntitySystem.md` → `CONTEXT_PACKS/SO_Config_Workflow.md` → `SHOOTER_GAME/V2_TDD/SG_V2_TDD_03_BUFF_DOT_PASSIVE.md` |
| 上下文效率 | 1 | 读取文件 ≤ 5 个 |
