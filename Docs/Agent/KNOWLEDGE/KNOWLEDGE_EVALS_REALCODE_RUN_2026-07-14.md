...
related_docs: Docs/Agent/KNOWLEDGE/KNOWLEDGE_EVALS_REALCODE_PLAN.md, Docs/Agent/KNOWLEDGE/KNOWLEDGE_EVALS.md
---
...
2. ✅ **PlayMode 验证流程**：TOOLS/MCP_INTEGRATION.md 新增「PlayMode 快速验证工作流」章节（7 步最小流程 + 操作矩阵 + 注意事项），AGENT_BOOTSTRAP 验证入口新增 PlayMode 验证行
