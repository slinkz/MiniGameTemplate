...
| 我要做什么 | 读什么文件 | 备注 |
|-----------|-----------|------|
| 新建一种敌人 | EC_TDD_06_CONFIG + SO_CATALOG §Entity | EntityConfigSO 字段 + 创建流程 |
| 新建一个技能 | EC_TDD_05_COMPONENTS §4.8 + SO_CATALOG §SkillConfigSO | 技能 SO + Effect 链路 |
| 新建一个 Buff | EC_TDD_05_COMPONENTS §4.10 + SO_CATALOG §BuffConfigSO | Buff SO + Duration/叠加 |
| 新增子弹花样 | SO_CATALOG §Danmaku + ATLAS_TDD_INDEX | 弹幕 SO + Atlas 纹理 |
