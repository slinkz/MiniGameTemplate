...
- 📦 **12 个即用模块** — 事件系统、数据管理、UI(FairyGUI)、音频、对象池、状态机、计时器、资源管理(YooAsset)、微信 SDK 桥接等
...
| [框架模块使用手册](FRAMEWORK_MODULES.md) | 12 个模块的详细 API、用法示例和注意事项 | 按需查阅 |
