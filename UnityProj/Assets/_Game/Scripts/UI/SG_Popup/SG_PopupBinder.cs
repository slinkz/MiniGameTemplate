...
namespace SG_Popup
{
    public class SG_PopupBinder
    {
        public static void BindAll()
        {
            UIObjectFactory.SetPackageItemExtension(PausePanel.URL, typeof(PausePanel));
            UIObjectFactory.SetPackageItemExtension(VictoryPanel.URL, typeof(VictoryPanel));
