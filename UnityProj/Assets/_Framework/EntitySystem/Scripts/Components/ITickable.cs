namespace MiniGameTemplate.Entity
{
    ...
    /// 时序：Buff=50 → Passive=60 → Decision=100 → AutoAim=120 → EnemyShoot=155 → Skill=160 → Health=250 → Movement=300 → Animation=400
    /// </summary>
    public static class TickOrders
    {
        ...
        public const int AutoAim   = 120;  // AutoAimComponent（Skill 之前）
