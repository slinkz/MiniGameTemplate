...
namespace MiniGameTemplate.EditorTools
{
    ...
    ///
    /// CHANGELOG:
    /// 2026-05-09  删除 PostExport 菜单项及相关方法（主包检查由微信开发者工具上传时自行校验）。
    /// 2026-05-08  CDN 根目录从 minigame/ 切换到 webgl/，PostExport 不再拷贝资源到 minigame/，仅保留主包大小预警。
    ...
    public static class BuildModeSwitch
    {
        ...
        // ────────────────── 枚举桥接（避免跨 asmdef 使用 Asset 命名空间的枚举）──────────────────（避免跨 asmdef 使用 Asset 命名空间的枚举）──────────────────
